...
Расширенная модификация для [Zapret Hub](https://github.com/bol-van/zapret), предназначенная для обхода большего количества блокировок со стороны Роскомнадзора.

## Возможности

- Обход блокировок тысяч заблокированных доменов (1.5M+ записей в списке)
